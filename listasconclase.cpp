...
public:
	...
	void buscarElemento(Tlista lista, int valor){
		...
		while(q!=NULL){
			if(q->nro==valor){
				cout << endl << " Encontrar en posicion "<<i<<endl;
				band=1;
			}
			q = q->sgte;
			i++;
	...
	//agregar funcion instertarordenado
	...
	do{
		...
		switch(op){
			case 1: cout <<"\n NUMERO A INSERTAR: "; cin >> _dato;
					l1.insertarInicio(lista, _dato); break;
			case 2: cout <<"\n NUMERO A INSERTAR: "; cin >> _dato;
					l1.insertarFinal(lista, _dato); break;
			case 3: cout <<"\n NUMERO A INSERTAR: "; cin >> _dato;
					cout <<"Posicion: "; cin >> pos;
					l1.insertarElemento(lista, _dato, pos); break;
			case 4: cout << "\n\n MOSTRANDO LISTA\n\n";
					l1.reportarLista(lista); break;
			case 5: cout << "\n Valor a buscar: "; cin >> _dato;
					l1.buscarElemento(lista, _dato); break;
			case 6: cout << "\n Valor a eliminar: "; cin >> _dato;
					l1.eliminarElemento(lista, _dato); break;
			case 7: cout << "\n Valor repetido a eliminar: "; cin >> _dato;
					l1.eliminaRepetidos(lista, _dato); break;
		}
		cout << endl << endl;
